...
function Map() {
    ...
    useEffect(() => {
        function getFeatureInfo(e){
            ...
            // dispatch({type: "showPolygonsPanel", isTrue:state.showPolygonsPanel})
            dispatch({type: "showPolygonCard", isTrue:false})
                ...
                <Grid item xs={4} style={{marginTop:"0.5rem", padding:"1rem"}}>
                    <Stack spacing={2} direction="column">
                        ...
                        <Button 
                            ...
                            onClick= {(e)=> (
                                resetPolygonChange(),
                                dispatch({type: "showPlacesPanel", isTrue:state.showPlacesPanel}))}
                                > PLACES
                        </Button>
                        ...
                        <Button 
                            ...
                            onClick= {(e)=> (
                                resetPolygonChange(),
                                dispatch({type: "showPointsPanel", isTrue:state.showPointsPanel}))}
                             > POINTS
                        </Button>
                        ...
                        <Button 
                            ...
                            onClick= {(e)=> (
                                resetPolygonChange(),
                                dispatch({type: "showLinesPanel", isTrue:state.showLinesPanel}))}
                                > LINES
                        </Button>
                                    ...
                                    {state.dummyDataPolygons.map((polygon) => (
                                        ...
                                        <TableCell align="right">
                                            <Button 
                                                ...
                                                onClick={()=>
                                                    dispatch({type: "showPolygonCard", isTrue:false},
                                                    dispatch({type: "showPolygonsPanel", isTrue:true}),
                                                    dispatch({type:"getPolygonInfo", 
